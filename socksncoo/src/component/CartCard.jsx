        ...
        <div className='flex gap-2 bg-white rounded-sm h-34 w-full  border border-gray-300'>
            ...
            <div className='flex flex-col gap-1.5 pt-1.5 pl-2'>
                ...
                <div className="flex items-center gap-2">
                    <button onClick={increaseQuantity} className="text-xl font-bold bg-gray-200 hover:bg-gray-300 w-8 h-5 flex justify-center items-center pb-1 rounded-sm shadow-sm">+</button>
                    <p className="text-xl font-bold">{product.quantity || 1}</p>
                    <button onClick={decreaseQuantity} className="text-xl font-bold bg-gray-200 hover:bg-gray-300 w-8 h-5 flex justify-center items-center pb-1 rounded-sm shadow-sm">-</button>
                </div>
